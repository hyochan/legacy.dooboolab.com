    ...
    return (
      <div className="root">
        <div className="body">
          ...
          <h3>
            두부랩(이하 ‘회사’라 한다)는 정보통신망이용촉진 및 정보보호 등에
            관한 법률, 개인정보 보호법 등에 따라 회원님의 개인정보를 보호하고
            이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여
            다음과 같이 개인정보 취급방침을 수립·공개합니다.
          </h3>
          <h1>제 2 조 (개인정보의 수집 항목 및 수집 방법)</h1>
          <h3>
            1. 회사는 회원가입, 서비스 제공에 관한 계약 이행 및 서비스 제공에
            따른 요금정산, 기타 서비스 제공을 위해 회원가입 당시 아래와 같은
            개인정보를 수집하고 있습니다.
            <br />
            <br />
            1) 회원 가입 및 관리
            ...
            수집될 수 있습니다.
            <br />
            - IP주소, 기기고유번호, 서비스 이용기록, 방문 기록, 불량 이용 기록
            등<br />
            <br />
            2. 개인정보의 수집 방법
            <br />
          ...
          <h3>
            ...
            등 필요한 조치를 이행할 예정입니다. 이하에서는 홈페이지나
            어플리케이션을 이하 ‘서비스’라 합니다.
            <br />
            <br />
            ...
            전문분야, 사진, 휴대전화 번호, IP주소, 기기고유번호, 서비스
            이용기록, 방문 기록, 불량 이용 기록 등 성명, 주소, 신용카드번호,
            은행계좌정보 등 결제정보
            <br />
            <br />
            개인정보의보유·이용 기간 : 사업자/단체 서비스 탈퇴시까지,
            ...
            <br />
            <br />
            1) 전자상거래 등에서의 소비자 보호에 관한 법률- 표시·광고에 관한
            기록 : 6개월
            <br />
          ...
          <h3>
            회원님 및 법정 대리인은 담당자(부서명 : 운영팀, 담당자 장효찬,
            연락처 : E) support@dooboolab.com )에게 언제든지 등록되어 있는 자신
            혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정, 가입해지를
            요청할 수 있습니다.
            <br />
            <br />
            회원님 및 법정대리인의 개인정보 조회, 수정은 회사의
            개인정보관리책임자에게 서면, 전화, 전자우편등을 통하여 하실 수
          ...
          <h3>
            ...
            <br />
            <br />
            2. 이 개인정보 취급방침은 2021. 8월 6일부터 적용되며, 이전의
            개인정보 취급방침은 아래에서 확인하실 수 있습니다.
          </h3>
        </div>
      </div>
    );
